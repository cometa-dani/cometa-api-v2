...
export const Footer: FC = () => {
  return (
    <footer className="w-full max-w-[85rem] py-16 mt-6 px-4 sm:px-6 lg:px-8 mx-auto">
      {/* <!-- Grid --> */}
      <div className="text-center">
        <div>
          <a className="flex-none text-xl font-semibold text-black dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" aria-label="Brand">Cometa App</a>
        </div>
        {/* <!-- End Col --> */}
